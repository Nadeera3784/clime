  ...
  <div class="space-y-16 relative container xl:max-w-7xl mx-auto w-full px-4 py-16 lg:px-8 lg:py-32 min-h-screen">
    ...
    <div v-if="isLoading">
        <div class="text-center">
            <svg role="status" class="inline mr-2 w-20 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
