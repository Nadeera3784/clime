  ...
  <footer  class="flex flex-none items-center bg-white">
    <div class="text-center flex flex-col md:text-left md:flex-row md:justify-between text-sm container xl:max-w-7xl mx-auto px-4 lg:px-8">
      <div class="pt-4 pb-1 md:pb-4">
        <a href="" target="_blank" class="font-medium text-indigo-600 hover:text-indigo-400">Clime</a> © 2020
      </div>
      <div class="pb-4 pt-1 md:pt-4 inline-flex items-center justify-center">
        ...
        <span>by <a href="" target="_blank" class="font-medium text-indigo-600 hover:text-indigo-400">Clime</a></span>
      </div>
    </div>
  </footer>
</template>
