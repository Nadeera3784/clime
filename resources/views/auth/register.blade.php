    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden max-w-10xl mx-auto p-4 lg:p-8 w-full">
      ...
      <div class="py-6 lg:py-0 w-full md:w-8/12 lg:w-6/12 xl:w-4/12 relative">
        ...
        <div class="mb-8 text-center">
          ...
          <p class="text-gray-500"> Create your own account in one single step </p>
        </div>
        <div class="flex flex-col rounded shadow-sm bg-white overflow-hidden">
            ...
            <div class="sm:p-5 lg:px-10 lg:py-8">
              ...
              @csrf
                <div class="space-y-1">
                  ...
                  <input class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Enter your first name" />
                </div>
                @error('name')
                ...
                <div class="space-y-1">
                  ...
                  <input class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="email" id="email" name="email" placeholder="Enter your email" />
                </div>
                @error('email')
                <div class="p-4 md:p-5 rounded text-red-700 bg-red-100">
                    <div class="flex items-center mb-3">
                ...
                <div class="space-y-1">
                  ...
                  <input class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="password" id="password" name="password" placeholder="Choose a strong password" />
                </div>
                @error('password')
                <div class="p-4 md:p-5 rounded text-red-700 bg-red-100">
                    <div class="flex items-center mb-3">
                ...
                <div class="space-y-1">
                  ...
                  <input class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="password" id="password_confirmation" name="password_confirmation" placeholder="Confirm your chosen password" />
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <span class="ml-2"> I accept <a href="javascript:void(0)" class="underline text-gray-600 hover:text-gray-500">terms &amp; conditions</a>
                  </span>
                </div>
          ...
          <div class="py-4 px-5 lg:px-6 w-full text-sm text-center bg-gray-50">
            <a class="font-medium text-indigo-600 hover:text-indigo-400" href="{{ route('login') }}">Return to Sign In</a>
          </div>
        </div>
      </div>
    </div>
